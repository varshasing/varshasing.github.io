...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    location: 'Remote',
    shortDescription: 'Software Intern at Lyte, a startup unifying sensing, compute, and software so robots get reliable 4D perception in messy, real-world conditions.',
    fullDescription: [
      'Details to be added upon completion of internship.',
    ],
    technologies: ['TBD' ],
  },
  {
    ...
    fullDescription: [
      ...
      'Undergraduate Courses: ENG EC414: Machine Learning [2x], ENG EC413: Computer Organization, ENG EC330: Applied Algorithms and Data Structures [2x], ENG EC311: Introduction to Logic Design; ENG EK122: Programming for Engineers [2x], ENG EK121: Introduction to Programming [2x].',
  ...
  },
  {
    ...
    fullDescription: [
      'Drove Perforce to GitLab migration for 1200+ applications with detailed planning, metrics tracking, and coordination with central DevOps team to manage large-scale organizational process, presented strategy to VP/CTO-level stakeholders.',
